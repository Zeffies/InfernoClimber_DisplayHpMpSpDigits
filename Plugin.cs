...
public class GUIEnergyBarConnector_Update
{
    ...
    static void DisplayHPStamMPHudDigits(GUIEnergyBarConnector __instance)
    {
        ...
        {
            // if you turn it off for some reason in the settings, this fixes it. also handles it so it can be changed dynamically with BepInEx Configuration Plugin
